...
class AdventureUI {
   ...
   */
// In app/public/js/ui/adventure-ui.js
renderAdventureHistory(adventures) {
const historyContainer = document.getElementById('adventure-history');
if (!historyContainer) {
  console.warn('Adventure history container not found in DOM');
  return;
}

console.log(`Rendering ${adventures.length} adventures for history`);

if (!adventures || adventures.length === 0) {
  historyContainer.innerHTML = '<p class="text-muted">No past adventures.</p>';
  return;
}
  ...
  return `
    <div class="card mb-3 adventure-history-card" data-adventure-id="${adventure.id}">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <strong>Gold:</strong> ${rewards.gold || 0}
          </div>
          <div class="col-md-4">
            <strong>Experience:</strong> ${rewards.experience || 0}
          </div>
          <div class="col-md-4">
